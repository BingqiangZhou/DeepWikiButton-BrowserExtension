...
// Create floating button with DeepWiki logo
function createFloatingButton() {
  ...
  button.className = 'deepwiki-floating-button';
  button.title = 'Open in DeepWiki';
  button.innerHTML = `
    <svg width="20" height="20" viewBox="110 110 460 500" fill="none">
...
// Handle navigation changes (GitHub uses SPA navigation)
// Use throttling to avoid performance issues from frequent DOM changes
const throttledCreateButton = throttle(createFloatingButton, 500);
const observer = new MutationObserver(throttledCreateButton);

// Only observe after document.body is available
if (document.body) {
